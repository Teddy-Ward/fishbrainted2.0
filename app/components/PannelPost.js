  ...
  return (
    <>
        ...
        <div className="text-left">
          {!image_url ? (<img src="random.png" className="shadow main-img" alt="random orange image"/>) : (<img src={imageLink} className="shadow main-img bg-[var(--link-color)]" alt="post image"/>)}
          <h1 className="drop-shadow-md pt-4 h-24 overflow-hidden">{title}</h1>
          <span className="banner"></span>
          <p className="h-36  overflow-hidden">
            {tagline}
          </p>
          <div className="stroke">
            <a href={postLink(slug_title)} className="pb-2 w-28 mt-2 ml-auto text-center">
              Read More
            </a>
          </div>
        </div>
